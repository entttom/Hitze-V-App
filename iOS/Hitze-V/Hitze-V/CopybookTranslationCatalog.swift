...
struct CopybookTranslationCatalog {
    ...
    private static let translations: [ResolvedLanguage: [String: String]] = [
        .fr: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d lieu de travail au-dessus de l'indice UV 5. Mettre en œuvre des mesures de protection UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d lieux de travail au-dessus de l'indice UV 5. Mettre en œuvre des mesures de protection UV.",
        ...
        .es: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d lugar de trabajo por encima del índice UV 5. Aplicar medidas de protección UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d lugares de trabajo por encima del índice UV 5. Aplicar medidas de protección UV.",
            "All day": "Todo el día",
        ...
        .it: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d luogo di lavoro sopra l'indice UV 5. Attuare le misure di protezione UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d luoghi di lavoro sopra l'indice UV 5. Attuare le misure di protezione UV.",
        ...
        .nl: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d werkplek boven UV-index 5. UV-beschermingsmaatregelen toepassen.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d werkplekken boven UV-index 5. UV-beschermingsmaatregelen toepassen.",
            "All day": "De hele dag",
            ...
            "Heat warnings": "Hittewaarschuwingen",
        ...
        .sv: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d arbetsplats över UV-index 5. Genomför UV-skyddsåtgärder.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d arbetsplatser över UV-index 5. Genomför UV-skyddsåtgärder.",
            "All day": "Hela dagen",
        ...
        .pt: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d local de trabalho acima do índice UV 5. Implementar medidas de proteção UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d locais de trabalho acima do índice UV 5. Implementar medidas de proteção UV.",
            "All day": "Todo o dia",
            ...
            "Warnings": "Avisos",
            "Heat warnings": "Alertas de calor",
        ...
        .ro: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d loc de muncă peste indicele UV 5. Implementați măsuri de protecție UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d locuri de muncă peste indicele UV 5. Implementați măsuri de protecție UV.",
            "All day": "Toată ziua",
            ...
            "Warnings": "Avertizări",
            "Heat warnings": "Alerte de căldură",
        ...
        .hr: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d radno mjesto iznad UV indeksa 5. Provedite mjere UV zaštite.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d radna mjesta iznad UV indeksa 5. Provedite mjere UV zaštite.",
            "All day": "Cijeli dan",
            ...
            "Warnings": "Upozorenja",
            "Heat warnings": "Upozorenja na vrućinu",
        ...
        .sl: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d delovno mesto nad UV-indeksom 5. Uvedite ukrepe UV-zaščite.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d delovna mesta nad UV-indeksom 5. Uvedite ukrepe UV-zaščite.",
            "All day": "Cel dan",
            ...
            "Warnings": "Opozorila",
            "Heat warnings": "Opozorila na vročino",
        ...
        .sk: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d pracovisko nad UV indexom 5. Zaveďte opatrenia na UV ochranu.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d pracoviská nad UV indexom 5. Zaveďte opatrenia na UV ochranu.",
            "All day": "Celý deň",
            ...
            "Heat warnings": "Výstrahy pred teplom",
        ...
        .cs: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d pracoviště nad UV indexem 5. Zaveďte opatření proti UV záření.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d pracoviště nad UV indexem 5. Zaveďte opatření proti UV záření.",
            "All day": "Celý den",
            ...
            "Warnings": "Varování",
            "Heat warnings": "Upozornění na horko",
        ...
        .da: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d arbejdsplads over UV-indeks 5. Iværksæt UV-beskyttelsesforanstaltninger.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d arbejdspladser over UV-indeks 5. Iværksæt UV-beskyttelsesforanstaltninger.",
            "All day": "Hele dagen",
        ...
        .fi: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d työpaikka UV-indeksin 5 yläpuolella. Ota käyttöön UV-suojatoimet.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d työpaikkaa UV-indeksin 5 yläpuolella. Ota käyttöön UV-suojatoimet.",
            "All day": "Koko päivä",
            ...
            "Heat warnings": "Hellevaroitukset",
        ...
        .et: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d töökoht üle UV-indeksi 5. Rakendage UV-kaitsemeetmeid.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d töökohad üle UV-indeksi 5. Rakendage UV-kaitsemeetmeid.",
            "All day": "Kogu päev",
        ...
        .lv: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d darba vieta virs UV indeksa 5. Ieviesiet UV aizsardzības pasākumus.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d darba vietas virs UV indeksa 5. Ieviesiet UV aizsardzības pasākumus.",
            "All day": "Visu dienu",
            ...
            "Heat warnings": "Karstuma brīdinājumi",
        ...
        .lt: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d darbo vieta virš UV indekso 5. Įgyvendinkite UV apsaugos priemones.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d darbo vietos virš UV indekso 5. Įgyvendinkite UV apsaugos priemones.",
            "All day": "Visą dieną",
            ...
            "Warnings": "Įspėjimai",
            "Heat warnings": "Karščio įspėjimai",
        ...
        .tr: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d iş yeri UV indeks 5'in üzerinde. UV koruma önlemlerini uygulayın.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d iş yeri UV indeks 5'in üzerinde. UV koruma önlemlerini uygulayın.",
            "All day": "Tüm gün",
            ...
            "Warnings": "Uyarılar",
            "Heat warnings": "Sıcaklık uyarıları",
        ...
        .pl: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d miejsce pracy powyżej indeksu UV 5. Wdrożyć środki ochrony UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d miejsca pracy powyżej indeksu UV 5. Wdrożyć środki ochrony UV.",
            "All day": "Cały dzień",
            ...
            "Heat warnings": "Ostrzeżenia przed upałem",
        ...
        .hu: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d munkahely 5 feletti UV-indexszel. UV-védelmi intézkedéseket kell bevezetni.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d munkahely 5 feletti UV-indexszel. UV-védelmi intézkedéseket kell bevezetni.",
            "All day": "Egész nap",
        ...
        .bg: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d работно място с UV индекс над 5. Въведете мерки за UV защита.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d работни места с UV индекс над 5. Въведете мерки за UV защита.",
            "All day": "Цял ден",
            ...
            "Heat warnings": "Предупреждения за горещини",
        ...
        .el: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d χώρος εργασίας πάνω από δείκτη UV 5. Εφαρμόστε μέτρα προστασίας από UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d χώροι εργασίας πάνω από δείκτη UV 5. Εφαρμόστε μέτρα προστασίας από UV.",
            ...
            "Heat warnings": "Προειδοποιήσεις ζέστης",
        ...
        .ga: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d láthair oibre os cionn innéacs UV 5. Cuir bearta cosanta UV i bhfeidhm.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d láithreacha oibre os cionn innéacs UV 5. Cuir bearta cosanta UV i bhfeidhm.",
        ...
        .mt: [
            ...
            "%d workplace above UV index 5. Implement UV protection measures.": "%d post tax-xogħol 'il fuq mill-indiċi UV 5. Implimenta miżuri ta' protezzjoni UV.",
            "%d workplaces above UV index 5. Implement UV protection measures.": "%d postijiet tax-xogħol 'il fuq mill-indiċi UV 5. Implimenta miżuri ta' protezzjoni UV.",
            ...
            "Warnings": "Twissijiet",
            "Heat warnings": "Twissijiet tas-sħana",
